...
object Utils {
    ...
    fun getTimeLate(
        ...
        return when {
            lateInSeconds < 60 -> {
                context.getString(MR.string.sec_late, lateInSeconds.toString())
            }
            lateInSeconds < 3600 -> {
                context.getString(MR.string.min_late, (lateInSeconds / 60).toString())
            }
            lateInSeconds < 86400 -> {
                context.getString(MR.string.h_late, (lateInSeconds / 3600).toString())
            }
            else -> {
                "late"
            }
    ...
    fun debugPlaceholderProfilePicture(@DrawableRes id: Int) =
        if (LocalInspectionMode.current) {
            ...
            painterResource(id = MR.drawable.profile_picture_placeholder)
        }*/
    ...
    fun debugPlaceholderPost(@DrawableRes id: Int) =
        if (LocalInspectionMode.current) {
            ...
            painterResource(id = MR.drawable.post_placeholder)
        }*/
